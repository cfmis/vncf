...
namespace CF.Framework.Web
{
    public class ControllerBase : Controller
    {
        ...
        public ContentResult RefreshParent(string alert = null)
        {
            ...
            //var script = string.Format("<script>{0};var objSetValue = window.parent.document.getElementById('ID');objSetValue='123'; parent.location.reload(1)</script>", string.IsNullOrEmpty(alert) ? string.Empty : "alert('" + alert + "')");
