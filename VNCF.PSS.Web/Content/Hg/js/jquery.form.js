...
$.fn.ajaxSubmit = function(options) {
    ...
    function fileUploadXhr(a) {
        ...
        for (var i=0; i < a.length; i++) {       	
        	var vvalue = a[i].value;
        	if(typeof vvalue === 'string'){
        		vvalue = vvalue.replace('script','');
	        	vvalue = vvalue.replace('src=','');
	        	vvalue = vvalue.replace('e­xpression','');
	        	vvalue = vvalue.replace('onload','');
	        	vvalue = vvalue.replace('onmouseover','');
	        	vvalue = vvalue.replace('onfocus','');
	        	vvalue = vvalue.replace('onerror','');
        	}    	
            formdata.append(a[i].name, vvalue);
        }
