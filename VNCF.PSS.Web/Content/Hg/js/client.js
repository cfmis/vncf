/*!
 中国电子口岸数据中心,JavaScript Library v1.3.9 For 客户端控件 v1.5.22
...
(function (window, document, navigator) {
    ...
    window.EportClient = {
        ...
        /**
         * 获取证书公钥
         * @param cert 证书内容,不可为空
         * @param callback
         */
        cusSpcGetCertPubKey: function (cert, callback) {
            if (typeof cert === "function") {
                callback = cert;
                cert = null;
            }
            baseInvoke("cus-sec_SpcGetCertPubKey", cert, callback);
        },
		 /**
         * 获取证书公钥Der
         * @param cert 证书内容,不可为空
         * @param callback
         */
        cusSpcGetCertPubKeyDer: function (cert, callback) {
            if (typeof cert === "function") {
                callback = cert;
                cert = null;
            }
            baseInvoke("cus-sec_SpcGetCertPubKeyDer", cert, callback);
        },
        /**
       ...
       pdfesSign: function (sessionId, orignFile, seSeal, cert, left, top, pageIndex, callback) {
         ...
         * @param callback
         */
        jscaSignData: function (inData, passwd,type, callback) {
            if (callback && typeof callback === "function") {
         ...
         * @param callback
         */
        jscaVerifyPIN: function (passwd,type, callback) {
            baseInvoke("jsca_JSCAVerifyPIN", {
				"passwd": passwd,
				"type":type
				}, callback);
        },
         ...
         * @param callback
         */
        jscaInitEnv: function (type,callback) {
            baseInvoke("jsca_JSCAInitEnv",{
				"type":type
			} ,callback);
        },
        /**
         ...
         * @param callback
         */
        jscaInitEnvALL: function (type,callback) {
            baseInvoke("jsca_JSCAInitEnvALL",{
				"type":type
			} ,callback);
        },
        /**
         ...
         * @param callback
         */
        raPortEncrypt: function (inData, passwd, callback) {
            baseInvoke("ra_PortEncrypt", (!!passwd) ? {
                "inData": inData,
                "passwd": passwd
            } : {"inData": inData}, callback);
        },
        ...
        SpcGetCertPubKey: function (certByteArray, callback) {
            if (typeof certByteArray === "function") {
                callback = certByteArray;
                certByteArray = null;
            }
            baseInvoke("security_SpcGetCertPubKey", ((!!certByteArray) ? {"certByteArray": certByteArray} : {}), callback);
        },		
        SpcGetCertPubKeyDer: function (certByteArray, callback) {
            if (typeof certByteArray === "function") {
                callback = certByteArray;
                certByteArray = null;
            }
            baseInvoke("security_SpcGetCertPubKeyDer", ((!!certByteArray) ? {"certByteArray": certByteArray} : {}), callback);
        },		
