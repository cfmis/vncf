...
namespace CF.Web
{
    ...
    public static class StaticFileHelper
    {
        ...
        public static string GetStaticServiceUri()
        {
            ...
            //    //staticServiceUri = "";// HttpContext.Current.Request.Url.Authority;//2019/03/12日取消
            //    staticServiceUri = "https://" + HttpContext.Current.Request.Url.Authority;//2019/03/12日取消
            staticServiceUri = "";
